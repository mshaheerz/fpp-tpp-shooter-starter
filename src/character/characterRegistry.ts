...
const SHARED_ANIMATIONS: Record<string, string> = {
  ...
  jump: './assets/character/animations/rifle_jump_in_place.glb',
  rifle_jump_in_place: './assets/character/animations/rifle_jump_in_place.glb',
  jump_2: './assets/character/animations/jump_2.glb',
  jump_forward: './assets/character/animations/jump_forward.glb',
